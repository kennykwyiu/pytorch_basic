...
print("\na ** 3:")
print(a ** 3)
print("\na before in-place pow_:")
print(a)
print("\na.pow_(3) (in-place):")
print(a.pow_(3))
print("\na after in-place pow_:")
print(a)
...
print("\ntorch.exp(a):")
print(torch.exp(a))
print("\ntorch.exp_(a) (in-place):")
print(torch.exp_(a))
print("\na after torch.exp_(a):")
print(a)
print("\na.exp():")
print(a.exp())
print("\na.exp_() (in-place):")
...
print("\ntorch.log(a):")
print(torch.log(a))
print("\ntorch.log_(a) (in-place):")
print(torch.log_(a))
print("\na after torch.log_(a):")
print(a)
print("\na.log():")
print(a.log())
print("\na.log_() (in-place):")
...
print("\ntorch.sqrt(a):")
print(torch.sqrt(a))
print("\ntorch.sqrt_(a) (in-place):")
print(torch.sqrt_(a))
print("\na after torch.sqrt_(a):")
print(a)
print("\na.sqrt():")
print(a.sqrt())
print("\na.sqrt_() (in-place):")
